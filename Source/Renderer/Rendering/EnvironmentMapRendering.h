...
struct FEnvironmentMapRenderingResources
{
	...
	void CreateRenderingResources(VQRenderer& Renderer, const FEnvironmentMapDescriptor& desc, int DiffuseIrradianceCubemapResolution, int SpecularMapMip0Resolution);
	void DestroyRenderingResources(VQRenderer& Renderer, HWND hwnd);
};
